...
def player_login():
    while True:
        ...
        try:
            ...
            print(Style.RESET_ALL + " ")
            print("Currently There is No Election")
            check_ = 0
            return None
    ...
    try:
        ...
        print(Style.RESET_ALL + " ")
        print("You Have Already Contributed Your Vote, Please Contact Admin For Further Details")
            ...
            while True:
                ...
                if len(password1) == 0:
                    ...
                    if password1 != password2:
                        ...
                        print(Style.BRIGHT + "                                     Both password don't match each other please type again\n ")
                        print(Style.RESET_ALL + " ")
                        print("both passwords  don't match each other please type again ")
...
def view_result():
    ...
    try:
        ...
        print(Style.RESET_ALL + " ")
        print("   You Have Not Created Any Election Before     or    Previous Election May be Deleted")
        return None
    ...
    if no_of_votes <= 0:
        ...
        print(Style.RESET_ALL + " ")
        print("  Till this point no one contributed   ")
        return None
    else:
        ...
        if len(display_result) == 1:
            ...
            print(Style.RESET_ALL + " ")
            print("\n")
            print("The election ties between " + display_result[0][0]+" and " +display_result[1][0])
    ...
    if check == 1:
        ...
        while True:
            ...
            if delete_ == '1':
                ...
                print(Style.RESET_ALL + " ")
                print("Deleted Previous Election")
...
def admin_login():
    while True:
        ...
        try:
            ...
            print(Style.RESET_ALL + " ")
            print(" There is no user with this username, Please Signup Before You Login")
